...
This project is a simple implementation of a Blackjack game where the player
tries to reach a hand value as close to 21 as possible without exceeding it.
The game focuses on JavaScript logic, state handling, and DOM manipulation.
...
1. Clone the repository:
   git clone https://github.com/ImSatyamK/black-jack.git
